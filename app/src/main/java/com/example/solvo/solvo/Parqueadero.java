...
public class Parqueadero extends FragmentActivity implements
    ...
    public void showDialog(){
        Dialog dialog = new Dialog(Parqueadero.this);
    ...
    private void exponerParqueaderos(View view){
        ...
        if(MenuPrincipal.Parqueaderos.size()>0) {
            ...
            Snackbar.make(view, Html.fromHtml("<font color=\"#FFBF00\">"+establ.size()+" PARQUEADEROS CERCANOS...</font>"), Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
        }else{
            notifyUser("No hay Parqueaderos Disponibles");
        }
    ...
    protected void onResume() {
        super.onResume();
        String who = AWSLoginModel.getSavedUserName(Parqueadero.this);
    ...
    public void cambiarEstado(String user, String estado){
        ...
        ConsultasDB.cambiarEstado(Parqueadero.this,user,estado);
    }
