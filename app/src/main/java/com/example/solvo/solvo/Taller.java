...
public class Taller extends FragmentActivity implements
    ...
    private void exponerTalleres(View view){
        ...
        if(MenuPrincipal.Talleres.size()>0) {
            ...
            for(Establecimiento e: MenuPrincipal.Talleres){
            ...
            Snackbar.make(view, Html.fromHtml("<font color=\"#FFBF00\">"+establ.size()+" TALLERES CERCANOS...</font>"), Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
        }else{
