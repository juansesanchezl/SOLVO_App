...
public class Peaje extends FragmentActivity implements
        OnMapReadyCallback,
    ...
    public List<HashMap<String,String>> peajes = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peaje);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                /*Snackbar.make(view, Html.fromHtml("<font color=\"#FFBF00\">CARGANDO PEAJES...</font>"), Snackbar.LENGTH_LONG)
    ...
    public void showDialog(){
        Dialog dialog = new Dialog(Peaje.this);
    ...
    private void exponerPeajes(View view){
        ...
        if(MenuPrincipal.Peajes.size()>0) {
            ...
            for(Establecimiento e: MenuPrincipal.Peajes){
            ...
            Snackbar.make(view, Html.fromHtml("<font color=\"#FFBF00\">"+establ.size()+" PEAJES CERCANOS...</font>"), Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
        }else{
            notifyUser("No hay Peajes Disponibles");
        }
    ...
    private void visualizarPeajes(){
        ...
        //mMap.clear();
        String peaj = "tolls";
        url = getUrl(latitudeUser, longitudeUser, peaj);
        ...
        try {
            ...
            peajes = parser.parse(googlePDRestaurante);
            guardarLugares(peajes);
            tipoServ = "PEAJES";
        ...
        if(peajes == null){
            System.out.println("Esta Vacio Peajes");
            peajes = getNearByPlacesData.nearbyPlaceList;
        }
        Toast.makeText(Peaje.this, "Mostrando Peajes Cercanos", Toast.LENGTH_LONG).show();
    }
    ...
    public void onConnectionSuspended(int i) {
        Toast.makeText(Peaje.this, "La conexión esta suspendida", Toast.LENGTH_LONG).show();
    }

    @Override
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Toast.makeText(Peaje.this, "La conexión tiene fallos, por favor verifique", Toast.LENGTH_LONG).show();
    }
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        for (Establecimiento e : MenuPrincipal.Peajes) {
            if(e.getIDEST().equals(marker.getSnippet())){
                ...
                Intent i = new Intent(Peaje.this,MasInformacion.class);
                String icon = "http://pegasus.javeriana.edu.co/~CIS1730CP08/img/ICONOS/Peaje.png";
        ...
        System.out.println("ENTRO AL MARCADOR CON ID:"+marker.getId());
        Intent i = new Intent(Peaje.this,MasInformacion.class);
        if(tipoServ.equals("PEAJES")){
            System.out.println("TAMAÑO:"+ peajes.size());
            for (int j = 0; j < peajes.size(); ++j) {
                HashMap<String,String> googlePlace =  peajes.get(j);
    ...
    protected void onResume() {
        super.onResume();
        String who = AWSLoginModel.getSavedUserName(Peaje.this);
    ...
    public void cambiarEstado(String user, String estado){
        ...
        ConsultasDB.cambiarEstado(Peaje.this,user,estado);
    }
